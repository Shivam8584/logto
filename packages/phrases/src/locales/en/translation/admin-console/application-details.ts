...
const application_details = {
  ...
  settings_description:
    'An "Application" is a registered software or service that can access user info or act for a user. Applications help recognize who’s asking for what from Hypedrive and handle the sign-in and permission. Fill in the required fields for authentication.',
  integration: 'Integration',
  integration_description:
    "Deploy with Hypedrive secure workers, powered by Cloudflare's edge network for top-tier performance and 0ms cold starts worldwide.",
  ...
  logto_endpoint: 'Hypedrive endpoint',
  application_id: 'App ID',
  application_id_tip:
    'The unique application identifier normally generated by Hypedrive. It also stands for “<a>client_id</a>” in OpenID Connect.',
  ...
  default_acr_values: 'Default authentication level',
  default_acr_values_tip:
    'The minimum Authentication Context Class Reference (ACR) every user of this application must satisfy by default. Higher levels include the requirements of the lower ones. Leave it as “Standard sign-in” to use the regular flow with no extra factor.',
  default_acr_values_placeholder: 'Standard sign-in (no extra factor)',
  default_acr_values_option_pwd: 'Password',
  default_acr_values_option_mfa: 'Multi-factor — any second factor',
  default_acr_values_option_phr: 'Phishing-resistant — passkey or security key',
  ...
  always_issue_refresh_token_label:
    'When enabled, Hypedrive will always issue refresh tokens, regardless of whether `prompt=consent` is presented in the authentication request. However, this practice is discouraged unless necessary, as it is not compatible with OpenID Connect and may potentially cause issues.',
  ...
  rotate_refresh_token_label:
    'When enabled, Hypedrive will issue a new refresh token for token requests when 70% of the original time to live (TTL) has passed or certain conditions are met. <a>Learn more</a>',
  rotate_refresh_token_label_for_public_clients:
    'When enabled, Hypedrive will issue a new refresh token for each token request. <a>Learn more</a>',
  ...
  app_domain_description_1:
    'Feel free to use your domain with {{domain}} powered by Hypedrive, which is permanently valid.',
  ...
  third_party_settings_description:
    'Integrate third-party applications with Hypedrive as your Identity Provider (IdP) using OIDC / OAuth 2.0, featuring a consent screen for user authorization.',
  ...
  permissions: {
    ...
    permission_description_tips:
      'When Hypedrive is used as an Identity Provider (IdP) for authentication in third-party apps, and users are asked for authorization, this description appears on the consent screen.',
    user_title: 'User',
    user_description:
  ...
  saml_idp_name_id_format: {
    ...
    persistent_description: 'Use Hypedrive user ID as Name ID',
    transient: 'Transient',
    transient_description: 'Use one-time user ID as Name ID',
    unspecified: 'Unspecified',
    unspecified_description: 'Use Hypedrive user ID as Name ID',
  ...
  saml_app_attribute_mapping: {
    ...
    description: 'Add attribute mappings to sync user profile from Hypedrive to your application.',
    col_logto_claims: 'Value of Hypedrive',
